...
configSchema = Schema({
    ...
    'internal': {
        ...
        Optional('ENABLE_URWID', default=False):
            And(bool, False),
        Optional('outputResolutions', default=[[], #0
                    [1920,1080], #1
                    [3840,1080], #2
                    [3840,2160], [3840,2160], #3-4
                    [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], #5-9
                    [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], #10-16
                    [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], #17-25
                    [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], [3840,2160], #26-36
                    [4480,2520]]):
